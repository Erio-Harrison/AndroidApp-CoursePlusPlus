...
public class PostedBasedTest {
  ...
  public void testFind() {
    ...
    TerminalNode terminalNode =
        new DateTimeNode(new Token(TokenType.DateTime, LocalDateTime.parse("2000-01-01T01:01:01")));
    CommentCache commentCache =
        new CommentCache(
            List.of(
                new Comment(
                    "1", "C", 2000, 1, "lorem", 10, LocalDateTime.parse("2000-01-01T01:01:00")),
                new Comment(
                    "2", "C", 2000, 1, "lorem", 10, LocalDateTime.parse("2000-01-01T01:01:01")),
                new Comment(
                    "3", "C", 2000, 1, "lorem", 10, LocalDateTime.parse("2000-01-01T01:01:02"))));
    ...
    assertThrows(
        ...
        () -> uut.find(TokenType.Like, terminalNode, commentCache));
  }
}
